 ...
 */
	[Serializable]
public sealed class FilePermission : java.security.Permission, java.io.Serializable {
    
    private const long serialVersionUID = 7930732926638008763L;
    ...
    private static readonly String[] actionList = new String[4] { "read", "write", "execute", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            "delete" }; //$NON-NLS-1$
    ...
    public override java.security.PermissionCollection newPermissionCollection() {
    ...
    public override int GetHashCode() {
        return (canonPath == null ? getName().GetHashCode() : canonPath.GetHashCode())
                + mask;
    }
