...
namespace biz.ritter.javapi.nio.charset
{
    ...
    public abstract class CharsetEncoder {
        ...
        private static readonly int ONGOING = 1;

        private static readonly int END = 2;

        private static readonly int FLUSH = 3;
        ...
        /// <returns></returns>
        public bool canEncode(String sequence)
        {
         ...
         *         <code>CoderResult.OVERFLOW</code>.
         */
        protected CoderResult implFlush(ByteBuffer outJ) {
        ...
        public CharsetEncoder replaceWith(byte[] replacement) {
            if (null == replacement || 0 == replacement.Length
                ...
                throw new java.lang.IllegalArgumentException("Replacement is illegal"); //$NON-NLS-1$
            }
            replace = replacement;
