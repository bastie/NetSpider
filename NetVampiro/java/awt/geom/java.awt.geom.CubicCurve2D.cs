...
public abstract class CubicCurve2D : Shape, java.lang.Cloneable {
    ...
    public class Float : CubicCurve2D {
        ...
        public override double getCtrlX1() {
            return ctrlx1;
        }

        
        public override double getCtrlY1() {
            return ctrly1;
        }

        
        public override double getCtrlX2() {
            return ctrlx2;
        }

        
        public override double getCtrlY2() {
            return ctrly2;
        }
        ...
        public override Point2D getCtrlP1() {
            return new Point2D.Float(ctrlx1, ctrly1);
        }

        
        public override Point2D getCtrlP2() {
        ...
        public override void setCurve(double x1, double y1, double ctrlx1, double ctrly1,
        ...
        public override Rectangle2D getBounds2D() {
            float rx1 = java.lang.Math.min(java.lang.Math.min(x1, x2), java.lang.Math.min(ctrlx1, ctrlx2));
            float ry1 = java.lang.Math.min(java.lang.Math.min(y1, y2), java.lang.Math.min(ctrly1, ctrly2));
            float rx2 = java.lang.Math.max(java.lang.Math.max(x1, x2), java.lang.Math.max(ctrlx1, ctrlx2));
            float ry2 = java.lang.Math.max(java.lang.Math.max(y1, y2), java.lang.Math.max(ctrly1, ctrly2));
    ...
    public class Double : CubicCurve2D {
        ...
        public override Rectangle2D getBounds2D() {
            double rx1 = java.lang.Math.min(java.lang.Math.min(x1, x2), java.lang.Math.min(ctrlx1, ctrlx2));
            double ry1 = java.lang.Math.min(java.lang.Math.min(y1, y2), java.lang.Math.min(ctrly1, ctrly2));
            double rx2 = java.lang.Math.max(java.lang.Math.max(x1, x2), java.lang.Math.max(ctrlx1, ctrlx2));
            double ry2 = java.lang.Math.max(java.lang.Math.max(y1, y2), java.lang.Math.max(ctrly1, ctrly2));
    ...
    public static double getFlatness(double x1, double y1, double ctrlx1, double ctrly1,
            double ctrlx2, double ctrly2, double x2, double y2)
    {
        return java.lang.Math.sqrt(getFlatnessSq(x1, y1, ctrlx1, ctrly1, ctrlx2, ctrly2, x2, y2));
    }
