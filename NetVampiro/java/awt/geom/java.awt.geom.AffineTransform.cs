...
namespace biz.ritter.javapi.awt.geom
{
     ...
     */
    [Serializable]
    public class AffineTransform : java.lang.Cloneable, java.io.Serializable
    {

        private static readonly long serialVersionUID = 1330973210523860834L;
        ...
        public void setToRotation(double angle)
        {
            ...
            if (java.lang.Math.abs(cos) < ZERO)
            {
                cos = 0.0;
                sin = sin > 0.0 ? 1.0 : -1.0;
            }
            else
                if (java.lang.Math.abs(sin) < ZERO)
                {
                    sin = 0.0;
                    cos = cos > 0.0 ? 1.0 : -1.0;
                }
