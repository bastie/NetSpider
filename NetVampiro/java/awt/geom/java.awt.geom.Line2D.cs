...
public abstract class Line2D : Shape, java.lang.Cloneable {
    ...
    public static bool linesIntersect(double x1, double y1, double x2,
    ...
    public static double ptSegDist(double x1, double y1, double x2, double y2, double px, double py) {
        return java.lang.Math.sqrt(ptSegDistSq(x1, y1, x2, y2, px, py));
    }
    ...
    public static double ptLineDist(double x1, double y1, double x2, double y2, double px, double py) {
        return java.lang.Math.sqrt(ptLineDistSq(x1, y1, x2, y2, px, py));
    }
