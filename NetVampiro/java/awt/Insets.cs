...
namespace biz.ritter.javapi.awt
{
    ...
    public class Insets : java.lang.Cloneable, java.io.Serializable
    {
        ...
        {
            int hashCode = org.apache.harmony.misc.HashCode.EMPTY_HASH_CODE;
            hashCode = org.apache.harmony.misc.HashCode.combine(hashCode, top);
            hashCode = org.apache.harmony.misc.HashCode.combine(hashCode, left);
            hashCode = org.apache.harmony.misc.HashCode.combine(hashCode, bottom);
            hashCode = org.apache.harmony.misc.HashCode.combine(hashCode, right);
            return hashCode;
        }
