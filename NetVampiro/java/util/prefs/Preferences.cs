...
namespace biz.ritter.javapi.util.prefs
{
    ...
    public abstract class Preferences
    {
        ...
        // permission
        private static readonly java.lang.RuntimePermission PREFS_PERM = new java.lang.RuntimePermission("preferences"); //$NON-NLS-1$

        // factory used to get user/system prefs root
        private static readonly PreferencesFactory factory;

        // default provider factory name for Windows
        private const String DEFAULT_FACTORY_NAME_WIN = "java.util.prefs.RegistryPreferencesFactoryImpl"; //$NON-NLS-1$
        ...
        private static String getNodeName(java.lang.Class c)
        {
