...
namespace biz.ritter.javapi.sql
{
    ...
    public class DriverManager
    {
         ...
         */
        private static readonly java.util.ArrayList<Driver> theDrivers = new java.util.ArrayList<Driver>(10);

        // Permission for setting log
        private static readonly SQLPermission logPermission = new SQLPermission(
                "setLog"); //$NON-NLS-1$
        ...
        {
            String theDriverList = java.lang.SystemJ.getProperty("jdbc.drivers", null); //$NON-NLS-1$
            ...
            foreach (String element in theDriverNames)
            {
                try
                {
