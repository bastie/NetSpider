...
namespace org.xml.sax.helpers
{
    ...
    public class ParserAdapter : XMLReader, DocumentHandler
    {
        ...
        //throws SAXException
        {
            ...
            String driver = java.lang.SystemJ.getProperty("org.xml.sax.parser");
        ...
        //
        private readonly static String FEATURES = "http://xml.org/sax/features/";
        private readonly static String NAMESPACES = FEATURES + "namespaces";
        private readonly static String NAMESPACE_PREFIXES = FEATURES + "namespace-prefixes";
        ...
        private bool prefixes = false;
        private bool uris = false;
         ...
         */
        sealed class AttributeListAdapter : Attributes
        {
             ...
             */
            internal void setAttributeList(AttributeList qAtts)
            {
                this.qAtts = qAtts;
            }
