...
namespace Kajabity.Tools.Java
{
    ...
    /// </summary>
    internal class JavaPropertyReader
    {
        ...
        private java.lang.StringBuilder keyBuilder = new java.lang.StringBuilder();
        private java.lang.StringBuilder valueBuilder = new java.lang.StringBuilder();
                ...
                switch( ch )
                {
                    ...
                    case 'u':
                        ...
                        for( int i = 0; i < 4; i++ )
                        {
                            ...
                            {
                                throw new java.lang.IllegalArgumentException( "Invalid Unicode character." );
                            }
                        }
                        return (char) uch;
                }
