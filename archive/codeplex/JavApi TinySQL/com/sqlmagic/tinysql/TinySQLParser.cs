...
namespace com.sqlmagic.tinysql
{
    ...
    {
        java.util.Vector<Object> columnList, tableList, actionList, valueList, contextList,
        ...
        int[] colTypes = { java.sql.Types.INTEGER, java.sql.Types.FLOAT, java.sql.Types.CHAR, java.sql.Types.DATE };
        bool distinct = false, defaultOrderBy = true;
 ...
 */
      ...
      try
      {
         ...
         if ( TinySQLGlobals.PARSER_DEBUG )
          ...
          if (TinySQLGlobals.DEBUG) java.lang.SystemJ.outJ.println(ex.StackTrace); //ex.printStackTrace(java.lang.SystemJ.outJ);
 ...
 */
      ...
      if ( createColumn.type == java.lang.Integer.MIN_VALUE ) throwException(8);
      if ( TinySQLGlobals.PARSER_DEBUG )
      ...
      return createColumn;
        ...
        {
            String[][] sqlSyntax = new String[7][];
            sqlSyntax[0] = new String[] { "SELECT", "FROM", "WHERE", "GROUP", "ORDER", "BY" };
            sqlSyntax[1] = new String[] {"INSERT","INTO","VALUES"};
            sqlSyntax[2] = new String[] {"DROP","TABLE"};
            sqlSyntax[3] = new String[] {"DELETE","FROM","WHERE"};
            sqlSyntax[4] = new String[] {"CREATE","TABLE"};
            sqlSyntax[5] = new String[] {"UPDATE","SET","WHERE"};
            sqlSyntax[6] = new String[] { "ALTER", "TABLE", "DROP", "MODIFY", "ADD", "RENAME" };

            /*String[][] sqlSyntax = new String[7][] {{"SELECT","FROM","WHERE","GROUP","ORDER","BY"},
        {"INSERT","INTO","VALUES"},
        {"DROP","TABLE"},
        {"DELETE","FROM","WHERE"},
        {"CREATE","TABLE"},
