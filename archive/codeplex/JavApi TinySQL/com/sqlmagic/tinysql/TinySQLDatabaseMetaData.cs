...
namespace com.sqlmagic.tinysql
{
     ...
     * the form of java.sql.ResultSet objects.
     * You can use the normal java.sql.ResultSet methods such as getString and getInt 
     ...
     * either a java.sql.ResultSet (which may be empty) is returned or a
     * SQLException is thrown.
     */

    public class TinySQLDatabaseMetaData : java.sql.DatabaseMetaData
    {
        ...
        public TinySQLDatabaseMetaData(java.sql.Connection connection)
        {
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support schema term.");
        }
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support procedure.");
        }
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support catalog.");
        }
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not catalog.");
        }
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support transaction isolation.");
        }
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support transactions.");
        }
         ...
         * @return java.sql.ResultSet - each row is a procedure description 
         * @exception SQLException if a database access error occurs
        ...
        /**
             ...
             * a result.
         */
        internal int procedureResultUnknown = 0;
        ...
        /**
             ...
             * a result.
         */
        internal int procedureNoResult = 1;
        ...
        /**
             ...
             * a result.
         */
        internal int procedureReturnsResult = 2;
         ...
         *
         * <P>Each row in the java.sql.ResultSet is a parameter description or
         ...
         * @return java.sql.ResultSet - each row describes a stored procedure parameter or 
         *      column
         * @exception SQLException if a database access error occurs
         * @see #getSearchStringEscape 
         */
         ...
         */
        internal int procedureColumnUnknown = 0;
         ...
         * <code>COLUMN_TYPE</code>
             ...
             * returned by the method <code>getProcedureColumns</code>.
         */
        internal int procedureColumnIn = 1;
         ...
         * <code>COLUMN_TYPE</code>
             ...
             * returned by the method <code>getProcedureColumns</code>.
         */
        internal int procedureColumnInOut = 2;
         ...
         * <code>COLUMN_TYPE</code>
             ...
             * returned by the method <code>getProcedureColumns</code>.
         */
        internal int procedureColumnOut = 4;
        /**
         ...
         * <code>COLUMN_TYPE</code>
             ...
             * returned by the method <code>getProcedureColumns</code>.
         */
        internal int procedureColumnReturn = 5;
         ...
         * <code>COLUMN_TYPE</code>
             ...
             * returned by the method <code>getProcedureColumns</code>.
         */
        internal int procedureColumnResult = 3;
         ...
         * <code>NULLABLE</code>
             ...
             * returned by the method <code>getProcedureColumns</code>.
         */
        internal int procedureNoNulls = 0;
         ...
         * <code>NULLABLE</code>
             ...
             * returned by the method <code>getProcedureColumns</code>.
         */
        internal int procedureNullable = 1;
         ...
         * <code>NULLABLE</code>
             ...
             * returned by the method <code>getProcedureColumns</code>.
         */
        internal int procedureNullableUnknown = 2;
         ...
         * @return java.sql.ResultSet - each row is a table description
         * @exception SQLException if a database access error occurs
         * @see #getSearchStringEscape 
         */
        public virtual java.sql.ResultSet getTables(String catalog, String schemaPattern,
         ...
         *  </OL>
         *
         * @return java.sql.ResultSet - each row has a single String column that is a
         * schema name 
         * @exception SQLException if a database access error occurs
         */
        public java.sql.ResultSet getSchemas()
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support schemas.");
        }
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support catalogues.");
        }
         ...
         * @param tableNamePattern a table name pattern 
         * @param columnNamePattern a column name pattern 
         * @return java.sql.ResultSet - each row is a column description
         * @exception SQLException if a database access error occurs
         * @see #getSearchStringEscape 
         */
        public virtual java.sql.ResultSet getColumns(String catalog, String schemaPattern,
         ...
         * <code>NULLABLE</code>
             ...
             * <code>getColumns</code>.
         */
        internal int columnNullableUnknown = 2;
         ...
         * @param columnNamePattern a column name pattern 
         * @return java.sql.ResultSet - each row is a column privilege description
         * @exception SQLException if a database access error occurs
         * @see #getSearchStringEscape 
         */
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support column privileges.");
        }
         ...
         * without a schema
         * @param tableNamePattern a table name pattern 
         * @return java.sql.ResultSet - each row is a table privilege description
         * @exception SQLException if a database access error occurs
         * @see #getSearchStringEscape 
         */
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support table privileges.");
        }
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support best row identifiers.");
        }
         ...
         */
        internal int bestRowTemporary = 0;
         ...
         * <code>SCOPE</code>
             ...
             * returned by the method <code>getBestRowIdentifier</code>.
         */
        internal int bestRowTransaction = 1;
         ...
         * <code>PSEUDO_COLUMN</code>
             ...
             * returned by the method <code>getBestRowIdentifier</code>.
         */
        internal int bestRowNotPseudo = 1;
        ...
        public java.sql.ResultSet getVersionColumns(String catalog, String schema,
                                String table)
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support version columns.");
        }
         ...
         */
        internal int versionColumnUnknown = 0;
         ...
         * <code>PSEUDO_COLUMN</code>
             ...
             * returned by the method <code>getVersionColumns</code>.
         */
        internal int versionColumnNotPseudo = 1;
         ...
         * <code>PSEUDO_COLUMN</code>
             ...
             * returned by the method <code>getVersionColumns</code>.
         */
        internal int versionColumnPseudo = 2;
         ...
         * without a schema
         * @param table a table name
         * @return java.sql.ResultSet - each row is a primary key column description 
         * @exception SQLException if a database access error occurs
         */
        public java.sql.ResultSet getPrimaryKeys(String catalog, String schema,
                                String table)
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support primary keys.");
        }
        ...
        public java.sql.ResultSet getImportedKeys(String catalog, String schema,
                                String table)
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support imported keys.");
        }
        ...
        /**
             ...
             * are deleted.
         */
        internal int importedKeyCascade = 0;
        ...
        /**
             ...
             * another table as a foreign key.
         */
        internal int importedKeyRestrict = 1;
         ...
         */
        internal int importedKeySetNull = 2;
         ...
         */
        internal int importedKeyNoAction = 3;
         ...
         */
        internal int importedKeySetDefault = 4;
         ...
         */
        internal int importedKeyInitiallyDeferred = 5;
        ...
        /**
             ...
             * <P>Indicates deferrability.  See SQL-92 for a definition.
         */
        internal int importedKeyInitiallyImmediate = 6;
        ...
        /**
             ...
             * <P>Indicates deferrability.  See SQL-92 for a definition.
         */
        internal int importedKeyNotDeferrable = 7;
         ...
         * without a schema
         * @param table a table name
         * @return java.sql.ResultSet - each row is a foreign key column description 
         * @exception SQLException if a database access error occurs
         * @see #getImportedKeys 
         */
        public java.sql.ResultSet getExportedKeys(String catalog, String schema,
                                String table)
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support exported keys.");
        }
        ...
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support cross reference.");
        }
         ...
         *      </UL>
         *  <LI><B>UNSIGNED_ATTRIBUTE</B> bool => is it unsigned?
         *  <LI><B>FIXED_PREC_SCALE</B> bool => can it be a money value?
         *  <LI><B>AUTO_INCREMENT</B> bool => can it be used for an 
         ...
         *  </OL>
         *
         * @return java.sql.ResultSet - each row is a SQL type description 
         * @exception SQLException if a database access error occurs
         */
        public virtual java.sql.ResultSet getTypeInfo()
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL getTypeInfo not yet implemented.");
        }
         ...
         */
        internal int typeNullableUnknown = 2;
         ...
         *  <LI><B>TABLE_SCHEM</B> String => table schema (may be null)
         *  <LI><B>TABLE_NAME</B> String => table name
         *  <LI><B>NON_UNIQUE</B> bool => Can index values be non-unique? 
         ...
         *     accurate
         * @return java.sql.ResultSet - each row is an index column description 
         * @exception SQLException if a database access error occurs
         */
        public java.sql.ResultSet getIndexInfo(String catalog, String schema, String table,
                        bool unique, bool approximate)
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support index infos.");
        }
         ...
         */
        internal short tableIndexStatistic = 0;
         ...
         */
        internal short tableIndexClustered = 1;
         ...
         */
        internal short tableIndexHashed = 2;
         ...
         */
        internal short tableIndexOther = 3;
         ...
         *
         * @param result set type, i.e. ResultSet.TYPE_XXX
         * @return true if changes are detected by the java.sql.ResultSet type
         * @exception SQLException if a database access error occurs
         */
         ...
         * @return java.sql.ResultSet - each row is a type description
         * @exception SQLException if a database access error occurs
         */
        public java.sql.ResultSet getUDTs(String catalog, String schemaPattern,
                          String typeNamePattern, int[] types)
        {//throws SQLException {
            throw new java.sql.SQLException("tinySQL does not support getUDTs.");
        }
        ...
        public bool supportsResultSetHoldability(int value)
        {
            switch (value)
            {
                case java.sql.ResultSetConstants.CLOSE_CURSORS_AT_COMMIT: return false;
                case java.sql.ResultSetConstants.HOLD_CURSORS_OVER_COMMIT: return true;
        ...
        {
            return java.sql.DatabaseMetaDataConstants.sqlStateXOpen;
        }
