...
namespace org.apache.commons.collections.functors
{
     ...
     */
    [Serializable]
    public class PredicateTransformer : Transformer, java.io.Serializable
    {

        /** Serial version UID */
        private static readonly long serialVersionUID = 5278818408044349346L;
        ...
        {
            return (iPredicate.evaluate(input) ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
        }
