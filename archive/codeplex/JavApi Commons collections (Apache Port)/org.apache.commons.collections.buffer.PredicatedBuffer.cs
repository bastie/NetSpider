...
namespace org.apache.commons.collections.buffer
{
     ...
     * @version $Revision: 7138 $ $Date: 2011-06-04 21:09:49 +0200 (Sa, 04. Jun 2011) $
     * 
     * @author Stephen Colebourne
     * @author Paul Jack
     */
    [Serializable]
    public class PredicatedBuffer : PredicatedCollection, Buffer
    {

        /** Serialization version */
        private static readonly long serialVersionUID = 2307609000539943581L;
         ...
         * @throws IllegalArgumentException if the buffer contains invalid elements
         */
        protected internal PredicatedBuffer(Buffer buffer, Predicate predicate)
            : base(buffer, predicate)
        {
        }
