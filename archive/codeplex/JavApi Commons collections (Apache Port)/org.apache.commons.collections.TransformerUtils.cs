...
namespace org.apache.commons.collections
{
    ...
    public class TransformerUtils
    {
         ...
         */
        public static Transformer instantiateTransformer(java.lang.Class[] paramTypes, Object[] args)
        {
        ...
        /** 
             ...
             * @throws IllegalArgumentException if the map is null
             */
        public static Transformer mapTransformer(java.util.Map<Object, Object> map)
        {
         ...
         * @throws IllegalArgumentException if the paramTypes and args don't match
         */
        public static Transformer invokerTransformer(String methodName, java.lang.Class[] paramTypes, Object[] args)
        {
            System.Type[] types = new System.Type[paramTypes.Length];
            for (int i = 0; i < paramTypes.Length; i++)
            {
            ...
            return invokerTransformer(methodName, types, args);
        }
        /// <summary>
