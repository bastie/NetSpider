...
namespace org.apache.commons.collections.iterators
{
     ...
     * @author Phil Steitz
     */
    public class ArrayListIterator : ArrayIterator
            , java.util.ListIterator<Object>, ResettableListIterator
    {
        ...
        public ArrayListIterator(Object array, int startIndex, int endIndex)
            : base(array, startIndex, endIndex)
        {
            this.startIndex = startIndex;
        }
        ...
        public virtual Object previous()
        {
            ...
            return java.lang.reflect.Array.get(this.array, this.index);
        }
        ...
        public virtual void set(Object o)
        {
            ...
            java.lang.reflect.Array.set(this.array, this.lastItemIndex, o);
        }
