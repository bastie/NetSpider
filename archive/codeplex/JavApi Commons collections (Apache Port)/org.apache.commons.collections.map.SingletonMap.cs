...
namespace org.apache.commons.collections.map
{
     ...
     * <li>the <code>MapIterator</code>, see {@link #mapIterator()}</li>
     * <li>the <code>KeyValue</code> interface (just cast - no object creation)</li>
     * </ul></p>
     * 
            ...
            : OrderedMap, BoundedMap, KeyValue, java.io.Serializable, java.lang.Cloneable
    {
        ...
        public virtual java.util.Set<java.util.MapNS.Entry<Object, Object>> entrySet()
        {
            ...
            return java.util.Collections<Object>.singleton(entry);
        }
        ...
        {
            return java.util.Collections<Object>.singleton(key);
        }
