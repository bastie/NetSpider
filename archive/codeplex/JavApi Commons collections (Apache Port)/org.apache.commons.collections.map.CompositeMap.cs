...
namespace org.apache.commons.collections.map
{
     ...
     */
    public class CompositeMap : java.util.Map<Object, Object>
    {

        /** Array of all maps in the composite */
        private java.util.Map<Object, Object>[] composite;
         ...
         */
        public CompositeMap()
            : this(new java.util.Map<Object, Object>[] { }, null)
        {
        }
         ...
         */
        public CompositeMap(java.util.Map<Object, Object> one, java.util.Map<Object, Object> two) :
            this(new java.util.Map<Object, Object>[] { one, two }, null)
        {
        }
         ...
         */
        public CompositeMap(java.util.Map<Object, Object> one, java.util.Map<Object, Object> two, MapMutator mutator) :
            this(new java.util.Map<Object, Object>[] { one, two }, mutator)
        {
        }
         ...
         * @throws IllegalArgumentException if there is a key collision
         */
        public CompositeMap(java.util.Map<Object, Object>[] composite)
            : this(composite, null)
        {
        }
         ...
         * @param mutator  MapMutator to be used for mutation operations
         */
        public CompositeMap(java.util.Map<Object, Object>[] composite, MapMutator mutator)
        {
            this.mutator = mutator;
            this.composite = new java.util.Map<Object, Object>[0];
         ...
         */
        public java.util.Map<Object, Object> removeComposited(java.util.Map<Object, Object> map)
        {
            lock (this)
            {
                ...
                for (int i = 0; i < size; ++i)
                {
                    ...
                    {
                        java.util.Map<Object, Object>[] temp = new java.util.Map<Object, Object>[size - 1];
                        java.lang.SystemJ.arraycopy(this.composite, 0, temp, 0, i);
                        java.lang.SystemJ.arraycopy(this.composite, i + 1, temp, i, size - i - 1);
                        this.composite = temp;
                        return map;
                    }
                }
        ...
        {
            int code = 0;
            for (java.util.Iterator<java.util.MapNS.Entry<Object,Object>> i = this.entrySet().iterator(); i.hasNext(); )
            {
                code += i.next().GetHashCode();
            }
            return code;
        }
        ...
        public interface MapMutator
        {
            ...
            void resolveCollision(
                CompositeMap composite, java.util.Map<Object, Object> existing, java.util.Map<Object, Object> added, java.util.Collection<Object> intersect);
             ...
             *            <tt>null</tt>.
             */
            Object put(CompositeMap map, java.util.Map<Object, Object>[] composited, Object key, Object value);
             ...
             *            <tt>null</tt>.
             */
            void putAll(CompositeMap map, java.util.Map<Object, Object>[] composited, java.util.Map<Object, Object> mapToAdd);
        }
    }
}