...
namespace org.apache.commons.collections.iterators
{
    ...
    public class EmptyIterator : AbstractEmptyIterator, ResettableIterator
    {
         ...
         */
        public static readonly ResettableIterator RESETTABLE_INSTANCE = new EmptyIterator();
        /**
         * Singleton instance of the iterator.
         * @since Commons Collections 2.1.1 and 3.1
         */
        public static readonly java.util.Iterator<Object> INSTANCE = RESETTABLE_INSTANCE;
