...
namespace biz.ritter.javapi.util
{
    ...
    public class Collections<T>
    {
               ...
               , SortedMap<K, V>
        {
            ...
            internal SynchronizedSortedMap(SortedMap<K, V> map)
                : base(map)
            {
                sm = map;
            }

            internal SynchronizedSortedMap(SortedMap<K, V> map, Object mutex)
                : base(map, mutex)
            {
                sm = map;
            }
        ...
        sealed class EmptySet : AbstractSet<Object>, java.io.Serializable
        {
            ...
            {
                return Collections<Object>.EMPTY_SET;
            }
        ...
        {
            return new IAC_IteratorEnumeration<T>(collection.iterator());
        }

        #region IAC_IteratorEnumeration
        internal sealed class IAC_IteratorEnumeration<T> : java.util.Enumeration<T>
        {
            private readonly java.util.Iterator<T> delegateInstance;
            public IAC_IteratorEnumeration(java.util.Iterator<T> it)
            {
                this.delegateInstance = it;
            }
        ...
        [Serializable]
        sealed class EmptyList<T> : AbstractList<T>,
                RandomAccess, java.io.Serializable
        {
            ...
            public override T get(int location)
            {
            ...
            private Object readResolve()
            {
                return Collections<Object>.EMPTY_LIST;
            }
        }
