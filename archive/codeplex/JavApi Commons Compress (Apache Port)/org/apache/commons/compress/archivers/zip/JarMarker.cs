...
namespace org.apache.commons.compress.archivers.zip {
     ...
     * @Immutable
     */
    public sealed class JarMarker : ZipExtraField {

        private static readonly ZipShort ID = new ZipShort(0xCAFE);
        private static readonly ZipShort NULL = new ZipShort(0);
        private static readonly byte[] NO_BYTES = new byte[0];
        private static readonly JarMarker DEFAULT = new JarMarker();
