...
namespace org.apache.commons.compress.archivers.zip {
     ...
     * @NotThreadSafe
     */
    public sealed class UnparseableExtraFieldData : ZipExtraField {
        private static readonly ZipShort HEADER_ID = new ZipShort(0xACC1);
        ...
        public void parseFromLocalFileData(byte[] buffer, int offset, int length) {
            ...
            java.lang.SystemJ.arraycopy(buffer, offset, localFileData, 0, length);
        }
        ...
        public void parseFromCentralDirectoryData(byte[] buffer, int offset,
            ...
            java.lang.SystemJ.arraycopy(buffer, offset, centralDirectoryData, 0, length);
