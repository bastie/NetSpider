...
namespace org.apache.commons.pool.impl
{
     ...
     * @since Pool 1.0
     */
    public class GenericObjectPoolFactory<T> : ObjectPoolFactory<T>
    {
        /**
        ...
        :
            this(factory, maxActive, whenExhaustedAction, maxWait, GenericObjectPool<T>.DEFAULT_MAX_IDLE, GenericObjectPool<T>.DEFAULT_MIN_IDLE, GenericObjectPool<T>.DEFAULT_TEST_ON_BORROW, GenericObjectPool<T>.DEFAULT_TEST_ON_RETURN, GenericObjectPool<T>.DEFAULT_TIME_BETWEEN_EVICTION_RUNS_MILLIS, GenericObjectPool<T>.DEFAULT_NUM_TESTS_PER_EVICTION_RUN, GenericObjectPool<T>.DEFAULT_MIN_EVICTABLE_IDLE_TIME_MILLIS, GenericObjectPool<T>.DEFAULT_TEST_WHILE_IDLE){
        }
         ...
         */
        public GenericObjectPoolFactory(PoolableObjectFactory<T> factory, int maxActive, byte whenExhaustedAction, long maxWait, int maxIdle, bool testOnBorrow, bool testOnReturn)
        :
            this(factory, maxActive, whenExhaustedAction, maxWait, maxIdle, GenericObjectPool<T>.DEFAULT_MIN_IDLE, testOnBorrow, testOnReturn, GenericObjectPool<T>.DEFAULT_TIME_BETWEEN_EVICTION_RUNS_MILLIS, GenericObjectPool<T>.DEFAULT_NUM_TESTS_PER_EVICTION_RUN, GenericObjectPool<T>.DEFAULT_MIN_EVICTABLE_IDLE_TIME_MILLIS, GenericObjectPool<T>.DEFAULT_TEST_WHILE_IDLE){
        }
         ...
         */
        public GenericObjectPoolFactory(PoolableObjectFactory<T> factory, int maxActive, byte whenExhaustedAction, long maxWait, int maxIdle, bool testOnBorrow, bool testOnReturn, long timeBetweenEvictionRunsMillis, int numTestsPerEvictionRun, long minEvictableIdleTimeMillis, bool testWhileIdle)
        :
            this(factory, maxActive, whenExhaustedAction, maxWait, maxIdle, GenericObjectPool<T>.DEFAULT_MIN_IDLE, testOnBorrow, testOnReturn, timeBetweenEvictionRunsMillis, numTestsPerEvictionRun, minEvictableIdleTimeMillis, testWhileIdle, GenericObjectPool<T>.DEFAULT_SOFT_MIN_EVICTABLE_IDLE_TIME_MILLIS){
        }
         ...
         */
        [Obsolete]
        protected int _maxIdle = GenericObjectPool<T>.DEFAULT_MAX_IDLE;
         ...
         */
        [Obsolete]
        protected int _minIdle = GenericObjectPool<T>.DEFAULT_MIN_IDLE;
         ...
         */
        [Obsolete]
        protected int _maxActive = GenericObjectPool<T>.DEFAULT_MAX_ACTIVE;
         ...
         */
        [Obsolete]
        protected long _maxWait = GenericObjectPool<T>.DEFAULT_MAX_WAIT;
         ...
         */
        [Obsolete]
        protected byte _whenExhaustedAction = GenericObjectPool<T>.DEFAULT_WHEN_EXHAUSTED_ACTION;
         ...
         */
        [Obsolete]
        protected bool _testOnBorrow = GenericObjectPool<T>.DEFAULT_TEST_ON_BORROW;
         ...
         */
        [Obsolete]
        protected bool _testOnReturn = GenericObjectPool<T>.DEFAULT_TEST_ON_RETURN;
         ...
         */
        [Obsolete]
        protected bool _testWhileIdle = GenericObjectPool<T>.DEFAULT_TEST_WHILE_IDLE;
         ...
         */
        [Obsolete]
        protected long _timeBetweenEvictionRunsMillis = GenericObjectPool<T>.DEFAULT_TIME_BETWEEN_EVICTION_RUNS_MILLIS;
         ...
         */
        [Obsolete]
        protected int _numTestsPerEvictionRun = GenericObjectPool<T>.DEFAULT_NUM_TESTS_PER_EVICTION_RUN;
         ...
         */
        [Obsolete]
        protected long _minEvictableIdleTimeMillis = GenericObjectPool<T>.DEFAULT_MIN_EVICTABLE_IDLE_TIME_MILLIS;

        /**
         * The {@link GenericObjectPool#getSoftMinEvictableIdleTimeMillis() softMinEvictableIdleTimeMillis}
         * setting for pools created by this factory.
         * [Obsolete] to be removed in pool 2.0.  Use {@link #getSoftMinEvictableIdleTimeMillis()}.
         */
        [Obsolete]
        protected long _softMinEvictableIdleTimeMillis = GenericObjectPool<T>.DEFAULT_MIN_EVICTABLE_IDLE_TIME_MILLIS;
         ...
         */
        [Obsolete]
        protected bool _lifo = GenericObjectPool<T>.DEFAULT_LIFO;
